...
I did not start out as a data scientist.  I earned my Bachelor of Science degree in Mechanical Engineering which allowed me to begin a career as a building energy modeler and HVAC Designer at a MEP (Mechanical, Electrical, Plumbing) consulting firm where I also earned my professional engineering license (PE).  During my time there, I taught myself how to program in VBA and Python as well as learned a monumental amount about what I was actually interested in doing.  As my career progressed, I realized just how much more I could accomplish by using available data, and programming best practices, to become a better engineer.  I eventually changed jobs to work for a green building certification company ([GBCI](http://www.gbci.org/)) and again found myself writing programs and collecting data for various tasks asked of me.  By then it was very clear that I was trying to solve my day to day work problems with analytical and programmatic solutions. The decision to enroll and earn my Master's degree in Data Science came pretty easy at that point.  
